public class MainClass {
    public static void main(String[] args) {
       ...
       /* Putnik putnik = new Putnik(1500, covek);
        // System.out.println(putnik.getNovac() + " " + putnik.getCovek().getIme_I_prezime());

        // System.out.println(putnik.dodajNovac(500.45));
        // System.out.println(putnik.getNovac());
        //System.out.println(putnik.skiniNovacSaRacuna(15));

        Vozac vozac = new Vozac(covek, "");
        //  System.out.println(vozac.getZanimanje());*/
